...
const centersByDay = {
   ...
   monday: ['سمارت الدقي', 'سمارت هرم (المجموعة الأساسية)', 'سمارت هرم (كورس الإنقاذ)', 'سمارت أكتوبر 1', 'سمارت أكتوبر 2'],
   tuesday: ['مودرن', 'ماراثون', 'نيو ستار 2', 'سمارت حدايق حلوان', 'ناسا المقطم'],
   wednesday: ['Oxford City 2', 'تاسك', 'الياسمين', 'الخليفة'],
   thursday: ['ليرن الدقي', 'A-One', 'الفا هرم (المجموعة الأساسية)', 'الفا هرم (كورس الإنقاذ)', 'سمارت الدقي (كورس الإنقاذ)'],
   friday: ['سيدات مصر', 'K', 'سيدات مصر (كورس الإنقاذ)'],
};
